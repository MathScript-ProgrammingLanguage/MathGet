...
<h1 style="display: flex; justify-content: center; align-items: center; gap: 0.2em;"><!-- <img src="./logo.svg" width="30"> --> MathGet</h1>
...
<p>MathGet, the package manager to install and manage MathScript's packages</p>
